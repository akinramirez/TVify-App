...
},{"../tv-shows-container":12,"jquery":1}],11:[function(require,module,exports){
'use strict';
...
(0, _jquery2.default)('#app-body').find('form').submit(function (ev) {
    ...
    (0, _jquery2.default)('#txtBuscar').val('');
});

},{"jquery":1,"page":2}],12:[function(require,module,exports){
'use strict';
...
var $tvShowsContainer = (0, _jquery2.default)('#app-body').find('.tv-shows'); // DEPENDENCIAS
